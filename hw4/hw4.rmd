...
Going further, we can average over each unique day of a year in the range 1987-2008 to see the average trend and quantify the typical deviance in number of aircrafts during any season relative to average.  
...
average_annual_dev %>%
  ggplot() +
    ...
    ylim(-130, 60) +
    coord_fixed(0.7) + 
    labs(title = "Average LAX Air Traffic per Day Centered by Annual Mean",
